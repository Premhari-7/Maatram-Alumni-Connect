...
import { FiMail, FiMapPin, FiBriefcase, FiUsers, FiAward, FiEdit3, FiMessageSquare, FiHeart, FiSend, FiBookmark, FiTrash2, FiShare2, FiPlus, FiX, FiLock, FiUserCheck, FiUserPlus, FiUser, FiBookOpen, FiThumbsUp, FiSmile, FiRepeat, FiCopy, FiLinkedin, FiTwitter, FiSun, FiStar, FiPlay } from 'react-icons/fi';
